...
- Treat `docs/research/` as a knowledge base, not a chronological research
  record. Keep current accepted interpretation there. Link the canonical
  experiment issue as the research record; the issue owns the full provenance
  chain to logbooks, pinned code, data, runs, and artifacts.
