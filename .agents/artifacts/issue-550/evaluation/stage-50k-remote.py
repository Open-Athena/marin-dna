...
# ///
"""Stage 50k on a bounded Iris CPU worker when the shared VM lacks headroom.
...
TASK = "/gonzalo/dna-exp550-50k-stage-20260914/0"
...
root = Path('/tmp/issue550-50k-stage')
...
def main() -> None:
    ...
    assert model["gcs_path"].endswith("/2026.09.10.9/hf/step-50000")
    report = {
        "model": MODEL,
