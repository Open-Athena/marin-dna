...
- [**Nucleotide dependency**](./interpretation/nucleotide-dependency) — per-locus dependency maps (the categorical Jacobian): how substituting one position shifts the model's predicted nucleotide distribution elsewhere, revealing coupled functional elements. See [#237](https://github.com/Open-Athena/marin-dna/issues/237).
