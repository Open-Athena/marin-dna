...
At their native context lengths on the same GH200, m5.1 scores one million variants in about one hour, compared with roughly 66 days for Evo 2 40B—a roughly 1,500× throughput advantage.[^inference-throughput]
