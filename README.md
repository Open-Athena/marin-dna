...
- **[Inference and VEP notebook](examples/model_inference_and_vep.py):**
  ...
  [open the GPU-verified revision on Molab](https://molab.marimo.io/github/Open-Athena/marin-dna/blob/33dfd2d55c7538fe6fb30023283c71845d76ba39/examples/model_inference_and_vep.py).
