...
After confirming native restore, `v5p-16`, finite advancing loss, native checkpoint 215593, and HF export 215593, launch the same committed code with `--mode production --run`.
