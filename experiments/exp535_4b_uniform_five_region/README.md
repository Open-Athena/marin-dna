...
The smoke output is `gs://marin-us-east5/checkpoints/dna-exp535-4b-uniform-five-region-smoke-v5p8-v2/2026.08.31`.
The production output is `gs://marin-us-east5/checkpoints/dna-exp535-4b-uniform-five-region/2026.08.31`.
...
Levanter's trainer stop is exclusive because `TrainerState.step` names the next step, while callback and checkpoint labels name the completed step.
The configured trainer stops are therefore 215594 for the smoke and 375574 for production.
