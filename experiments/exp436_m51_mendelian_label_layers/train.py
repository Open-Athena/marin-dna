"""Train the missing block-1 SAE trajectory for issue 436."""
...
# Retain #426's normalization sample exactly so the new block-1 dictionary is
# comparable to the existing block-10 and block-19 dictionaries.
...
def make_sae_config(block_index: int) -> BatchTopKTrainingSAEConfig:
    ...
    return BatchTopKTrainingSAEConfig(
        ...
        metadata=SAEMetadata(
            ...
            dataset_path="exp436-pinned-five-way-fwd-rc-stream",
            seed=SEED,
...
def dry_run_manifest(run_id: str, *, compile_llm: bool) -> dict[str, Any]:
    ...
    return {
        ...
        "interpretation_boundary": {
            ...
            "post_training": "fixed #436 Mendelian layer-resolved label protocol",
...
def main() -> None:
    ...
    parser.add_argument("--run-id", default="dna-exp436-block01-seed288")
