...
# MarinDNA ortholog-RAG 46M — 2M-token batch, 30k steps
...
followed by the human window. The 46M run uses 256 documents per TPU chip and
does not use gradient accumulation.

The exact self-contained training launcher is
[`launch_large_batch_30k.py`](https://github.com/Open-Athena/marin-dna/blob/f076021674dc32205bc1c79bf0d44f477c0fed52/experiments/exp402_rag_glm/launch_large_batch_30k.py#L1-L127).
