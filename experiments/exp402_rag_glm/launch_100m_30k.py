"""Issue #402: train the fresh 103.8M ortholog-RAG model for 30,000 steps.

Only model scale differs from ``launch_30k.py``. The corpus, context, token
batch, 3.93B-token AdamH transfer, WSD fractions, validation cadence, and
permanent 1,000-step checkpoint/export policy are identical.
"""
...
CHECKPOINT_NAME = "checkpoints/dna-exp402-rag-h768-p104m-30k"
RUN_ID = "dna-exp402-rag-h768-p104M-30K-scratch"
...
def build() -> ArtifactStep:
    """Assemble the fresh 103.8M, 30,000-step training run."""
