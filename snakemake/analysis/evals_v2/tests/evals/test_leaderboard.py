"""Tests for ``marin_dna_evals.leaderboard``.
...
from marin_dna_evals.metrics import GLOBAL_SUBSET, MACRO_AVG_SUBSET
from marin_dna_evals.models import Model
...
def _patch_methods(
    ...
    monkeypatch.setattr(
        "marin_dna_evals.models.load_models",
        lambda: methods,
    )
...
def test_gpn_star_parquet_path_resolves_to_s3():
    ...
    from marin_dna_evals.leaderboard import _parquet_path
...
def test_storage_options_off_by_default(monkeypatch: pytest.MonkeyPatch):
    ...
    from marin_dna_evals.leaderboard import _storage_options
