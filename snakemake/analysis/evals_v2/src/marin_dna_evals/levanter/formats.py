...
``marin_dna_evals.levanter.__init__`` imports this module so any code that does
``import marin_dna_evals.levanter`` activates the registration.
"""
    ...
    try:
        ...
        if "DNALmDatasetFormat" in inspect.getsource(original):
            raise RuntimeError(
                ...
                "marin_dna_evals.levanter.formats is likely redundant. Verify and "
