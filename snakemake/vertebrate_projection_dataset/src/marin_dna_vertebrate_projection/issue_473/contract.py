"""Isolated issue #473 projection acceptance and resizing contract.

Copied from the established contract so center-seeded span gates can be
changed without altering the S3-backed production path.
"""
