...
from marin_dna.pipelines.projection.taxonomy import normalize_zoonomia_leaf
...
MAMMAL_TSV = (
    REPO_ROOT / "snakemake/zoonomia_projection_dataset/config/"
...
def main() -> None:
    ...
    default_dir = REPO_ROOT / "snakemake/vertebrate_projection_dataset/config"
    parser.add_argument(
        "--candidate-output",
        type=Path,
