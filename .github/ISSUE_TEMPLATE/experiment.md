...
> Labels: this template sets the `experiment` Type. Add Area label(s) as applicable (`modeling`, `data`, `hyperparameter-optimization`, `evals`, `baselines`, `interpretation`). See AGENTS.md → GitHub Communication → Issue labels.
