...
| C7 | m5.1 used about 1,980× fewer reported training FLOPs and achieved about 2,330× higher as-deployed variant-scoring throughput than Evo 2 40B. | headline_cost_performance.svg; W&B lineage records; Evo 2 Table 1; issues #354 and #430; commit d9dfedc arithmetic audit. | m5.1 used 1.13498e21 recorded FLOPs over 166.01B tokens versus Evo 2's estimated 2.25e24 FLOPs over 9.3T tokens, a 1,982× ratio. Optimized m5.1 achieved 1,467,776 variants/hour versus Evo 2's source-rounded 630, an approximate 2,330× ratio. The throughput result is same-GH200, steady-state, embeddings-on, and native-context rather than same-context or per-token efficiency. | Supported with exact arithmetic and explicit comparability/precision limitations. |
