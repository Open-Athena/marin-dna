...
//
// Figures in `figs/` were generated by `plots/cshl26_poster.py` (matplotlib
// SVGs: timescale, r3, specialist_bars; generator removed in the main-trim
// #332 — see git history) plus a few hand-coded cartoons (region_legend,
// timescale_legend).
