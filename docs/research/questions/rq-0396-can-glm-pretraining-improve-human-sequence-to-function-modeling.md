...
- Can a causal checkpoint be converted by removing its attention mask and continuing with masked-token training, as proposed in [#393](https://github.com/Open-Athena/marin-dna/issues/393), or is bidirectional training from random initialization ultimately better?
