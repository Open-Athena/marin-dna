...
- [#473](https://github.com/Open-Athena/marin-dna/issues/473) compared full-window and center-1 projection on fixed anchors with recovery, reverse-trace QC, matched-token training, paired Mendelian uncertainty, Complex, SGE, and shared-row loss.
